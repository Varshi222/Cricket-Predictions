...
rfa = RandomForestRegressor(n_estimators=20, random_state=0)
rfa.fit(X_train, y_train)

pr=rfa.predict(X_test)
print("Error Percentage = ",round(metrics.mean_absolute_percentage_error(y_test,pr)*100,2))

pickle.dump(rfa, open('runrate.pkl', 'wb'))
